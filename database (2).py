...
#             }
#             db.collection(company_name).document(u'employee').collection('employee').document(new_id).set(personal_data)
#
#             # ADD LEAVE DATA
#
#             leave_data = {
...
#             }
#             db.collection(company_name).document(u'employee').collection('employee').document(new_id).collection(
...
#                     'year': 2023,
#                 }
#                 db.collection(company_name).document('employee').collection('employee').document(new_id).collection('salaryslips').document("sal00"+str(i)).set(salary_slip_data)
#             # ADD TDS DATA
#
#             tds_detail = {
...
#
#
#             db.collection(company_name).document(u'employee').collection('employee').document(new_id).collection("tdsmst").document("tds").set(tds_detail)
#
...
#     #             }
#     #
#     #             db.collection(company_name).document(u'admin').set(admin_data)
#     #
#     #
#     #             # ADD DEPARTMENT DATA
