...
class SalaryCalculation():
    ...
    def generate_salary(self, companyname, workingday):
        ...
        for key,value in employee_list.items():
            ...
            emp_basic_salary = round(float(emp_salary) * float(int(salary_percentage['hrapercentage'])/100), 2)

            emp_hra = round(emp_basic_salary * float(int(salary_percentage['hrapercentage'])/100), 2)

            emp_da = round(emp_basic_salary * float(int(salary_percentage['dapercentage'])/100), 2)
